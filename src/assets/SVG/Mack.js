  ...
  return (
    ...
    >
      ...
      <g filter="url(#filter1_i)">
        <circle cx="211.404" cy="271.618" r="53.4039" fill="white" />
      </g>
      <circle
        cx="211.404"
        cy="271.618"
      ...
      <g filter="url(#filter2_i)">
        <circle cx="442.369" cy="221.915" r="53.4039" fill="white" />
      </g>
      <circle
        cx="442.369"
        cy="221.915"
      ...
      <mask id="path-7-inside-2" fill="white">
        <path d="M382.858 243.511C398.381 243.511 411.415 256.456 406.167 271.065C402.757 280.56 397.586 289.415 390.842 297.136C377.868 311.988 359.95 321.633 340.408 324.283C320.867 326.933 301.027 322.409 284.566 311.549C276.009 305.903 268.667 298.745 262.851 290.501C253.902 277.817 263.017 261.869 277.979 257.734L325.78 244.526C328.219 243.853 330.737 243.511 333.266 243.511H382.858Z" />
      </mask>
      <path
        d="M382.858 243.511C398.381 243.511 411.415 256.456 406.167 271.065C402.757 280.56 397.586 289.415 390.842 297.136C377.868 311.988 359.95 321.633 340.408 324.283C320.867 326.933 301.027 322.409 284.566 311.549C276.009 305.903 268.667 298.745 262.851 290.501C253.902 277.817 263.017 261.869 277.979 257.734L325.78 244.526C328.219 243.853 330.737 243.511 333.266 243.511H382.858Z"
        fill="white"
        stroke="#19007D"
        strokeWidth="14"
      ...
      <defs>
        ...
        >
          ...
          <feColorMatrix
            type="matrix"
            values="0 0 0 0 0.313726 0 0 0 0 0.141176 0 0 0 0 1 0 0 0 1 0"
          />
          <feBlend mode="normal" in2="shape" result="effect1_innerShadow" />
        </filter>
        <filter
